                            ...
                            <div className={styles.box}>
                                <div className={styles.contentMargin}>
                                    <div>
                                        ...
                                        <label className={styles.agreement} style={{ color: "blue" }}><input type="checkbox" className={styles.input_check} checked={agreementCheckboxes.four} onChange={() => handleCheckboxChange('four')} /> 필수 <span> 구매회원 약관 동의</span></label>
